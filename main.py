...
# 動的なテーブル
st.dataframe(df.style.highlight_max(axis = 0) , width = 800 , height = 400)
...
# 画像の読み込み
img = Image.open('05-0275.jpg')
st.image(img,caption = 'Mac Desktop' , use_column_width = True)
